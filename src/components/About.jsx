...
function About() {
  ...
  return (
    <section id="about" className="min-h-screen py-16 sm:py-20 bg-gray-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 relative z-10">
        ...
        >
            ...
            <div className="relative">
              ...
              <motion.img
                ...
                className="relative
                  ...
                  lg:w-72 lg:h-72
                  xl:w-80 xl:h-80
                  rounded-full object-cover border-4 border-gray-800 shadow-2xl cursor-pointer"
              />
          ...
          {/* About Text */}
          <motion.div variants={container} className="flex-1 w-full space-y-5 sm:space-y-6">
            ...
            >
              ...
              >
                I'm <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Narendra Chapagain</span>
              </motion.h3>

              <motion.p
                variants={itemFadeUp}
                className="text-gray-400 text-sm sm:text-base leading-relaxed mb-3 sm:mb-4"
              >
                A passionate <strong className="text-gray-300">frontend developer</strong> and a final-year Computer Science student.
                I love crafting smooth, responsive, and modern web interfaces using{' '}
                <strong className="text-gray-300">React, JavaScript, Tailwind CSS,</strong> and other frontend technologies.
              </motion.p>
            ...
            >
              ...
              <motion.p variants={itemFadeUp} className="text-gray-400 text-sm sm:text-base leading-relaxed">
        ...
        >
          ...
          >
            Skills & <span className="bg-gradient-to-r from-cyan-400 to-purple-600 bg-clip-text text-transparent">Technologies</span>
          </motion.h3>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4">
            {skills.map((skill, index) => (
              ...
              >
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-purple-600/20 opacity-0 group-hover:opacity-100 transition-opacity -z-10"
                />
                {skill}
              </motion.div>
            ))}
        ...
        >
          ...
          >
            ...
            <span className="group-hover:translate-x-0.5 transition-transform">Download CV</span>
          </motion.button>
