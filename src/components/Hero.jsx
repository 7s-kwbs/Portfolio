...
function Hero() {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 px-6 bg-gray-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
        ...
        <div className="text-center md:text-left space-y-6 order-2 md:order-1">
          ...
          <div className="inline-block px-4 py-1.5 rounded-full border border-cyan-500/30 bg-cyan-500/5 backdrop-blur-sm">
